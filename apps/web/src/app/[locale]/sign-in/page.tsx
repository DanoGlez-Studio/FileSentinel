  ...
  return (
    <main className="relative mx-auto flex min-h-screen w-full max-w-5xl items-center p-6 md:p-10">
      <div className="absolute left-4 top-4 md:left-10 md:top-10">
        <Link className="rounded-full border border-brand-300/80 bg-white/80 px-4 py-2 text-xs font-semibold text-brand-800 backdrop-blur-sm transition hover:border-brand-500 hover:text-brand-900" href={`/${locale}`}>
          {t("signInPage.back")}
        </Link>
      </div>
      ...
      <section className="grid w-full gap-6 md:grid-cols-[1.1fr_0.9fr]">
        <article className="relative overflow-hidden rounded-3xl border border-brand-200 bg-gradient-to-br from-brand-100 via-white to-brand-50 p-7 shadow-lg md:p-10">
          ...
          <div className="relative z-10">
            ...
            <h1 className="mt-4 text-3xl font-bold leading-tight text-brand-900 md:text-4xl">{t("signInPage.title")}</h1>
            <p className="mt-4 max-w-md text-sm leading-relaxed text-brand-800 md:text-base">{t("signInPage.subtitle")}</p>

            <div className="mt-7 grid gap-2 text-sm text-brand-900">
              <p className="rounded-lg border border-brand-200/90 bg-white/65 px-3 py-2">{t("signInPage.benefitOne")}</p>
              <p className="rounded-lg border border-brand-200/90 bg-white/65 px-3 py-2">{t("signInPage.benefitTwo")}</p>
              <p className="rounded-lg border border-brand-200/90 bg-white/65 px-3 py-2">{t("signInPage.benefitThree")}</p>
            </div>
          </div>
        </article>
          ...
          <div className="mt-5 grid gap-3">
            ...
            >
              <span className="flex items-center gap-3">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 text-xs font-bold text-brand-800">D</span>
                {t("signInPage.discord")}
              </span>
              <span className="text-brand-500 transition group-hover:text-brand-800" aria-hidden="true">&rarr;</span>
            </Link>
            <Link
              className="group flex items-center justify-between rounded-xl border border-brand-300 bg-white px-4 py-3 text-sm font-semibold text-brand-900 transition hover:border-brand-500 hover:bg-brand-50"
            ...
            >
              <span className="flex items-center gap-3">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 text-xs font-bold text-brand-800">G</span>
                {t("signInPage.google")}
              </span>
              <span className="text-brand-500 transition group-hover:text-brand-800" aria-hidden="true">&rarr;</span>
            </Link>
            ...
            >
              <span className="flex items-center gap-3">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-brand-100 text-xs font-bold text-brand-800">M</span>
